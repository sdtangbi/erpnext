...
def get_columns(data):
	columns = [
		...
		_("Net Salary(A-(B+C))") + ":Currency:140", _("Salary Tax(X)") + ":Currency:120", _("Health Contr(Y)") + ":Currency:120",
		_("Total(X+Y)") + ":Currency:120", _("Company") + ":Link/Company:120", _("Cost Center") + ":Link/Cost Center:120",
